package org.feynix.application.conversation.service.message.agentv2;
...
import org.feynix.application.conversation.service.message.agentv2.analyzer.MessageAnalyzer;
import org.feynix.application.conversation.service.message.agentv2.executor.AgentLoopExecutor;
...
//            Boolean analyzeResult = true;
    ...
    private <T> void handleNormalMessage(
        ...
        ChatRequest chatRequest = chatContext.prepareChatRequest();
