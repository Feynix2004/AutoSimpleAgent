...
public class CreateAgentRequest {
    ...
    public CreateAgentRequest(String name, String description, String avatar, AgentType agentType,
                              String systemPrompt, String welcomeMessage, LLMModelConfig LLMModelConfig,
    ...
    public CreateAgentRequest(String name, String description, String avatar, Integer agentTypeCode,
        ...
        this(name, description, avatar,
                ...
                systemPrompt, welcomeMessage, LLMModelConfig, tools, knowledgeBaseIds, userId);
    }
    ...
    public void setModelConfig(LLMModelConfig LLMModelConfig) {
        this.LLMModelConfig = LLMModelConfig;
    }
